...
function cals() {
  var persons = document.querySelectorAll('.counter-block-input')[0]; //Получаем первый элемент(input)
...
function slieder() {
  var slideIndex = 1; //Парамтер текущего слайда
...
function tabs() {
  ...
  var tab = document.querySelectorAll('.info-header-tab'),
      //Хранит псевдомассив наших табов
  info = document.querySelector('.info-header'),
      //Содержит список табов
...
function timer() {
  ...
  var descrTime = document.querySelector('.timer-action');

  function getTimeRemaining(endtime) {
    var t = Date.parse(endtime) - Date.parse(new Date());
    var seconds = Math.floor(t / 1000 % 60); //секунды

    var minutes = Math.floor(t / 1000 / 60 % 60); //минуты

    var hours = Math.floor(t / (1000 * 60 * 60)); //час
    // let month = Math.floor((t/1000/60) % 24);//месяц
    // let days = Math.floor((t / (1000 * 60 * 60 * 24)));//дни

    if (t < 0) {
      var timerFinish = document.querySelector('.timer-finish');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var calc = __webpack_require__(/*! ./parts/cals */ "./src/js/parts/cals.js");

  var form = __webpack_require__(/*! ./parts/form */ "./src/js/parts/form.js");

  var slider = __webpack_require__(/*! ./parts/slider */ "./src/js/parts/slider.js");

  var tabs = __webpack_require__(/*! ./parts/tabs */ "./src/js/parts/tabs.js");

  var timer = __webpack_require__(/*! ./parts/timer */ "./src/js/parts/timer.js");

  var modal = __webpack_require__(/*! ./parts/modal */ "./src/js/parts/modal.js");
